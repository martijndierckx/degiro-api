...
function getTransactionsRequest(accountData, accountConfig, config) {
    return new Promise(function (resolve, reject) {
        ...
        var uri = "".concat(accountConfig.data.reportingUrl).concat(DeGiroEnums_1.DEGIRO_API_PATHS.GET_TRANSACTIONS, "?intAccount=").concat(accountData.data.intAccount, "&sessionId=").concat(accountConfig.data.sessionId, "&groupTransactionsByOrder=false").concat(params);
